...
public class CustomAlertDialog {
    ...
    public static class Builder {
        ...
        private CharSequence mOptional;
         ...
         * @return image
         */
        public Builder setOptionalImage(@Nullable final CharSequence optionalImage) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public Builder setImage(@StringRes final int imageId) {
        ...
        public AlertDialog create() {
            ...
            ImageView ivImage = (ImageView) dialogView.findViewById(R.id.tvImageDelete);
            //set title
            if (mTitle != null) {
            ...
            if (mOptional != null && !mOptional.equals("null")) {
